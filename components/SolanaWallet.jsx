  ...
  return (
    <div style={{ backgroundColor: 'lightgray', padding: '20px',paddingTop:'10px', height: "fit-content",borderRadius:"5px",margin:"10px" }}>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <button onClick={()=>{addSolWallet();setVisible(true)}} style={{ border: "0px", borderRadius: "5px", padding: "5px" }} >Add Wallets</button>
        <button onClick={() => {
          setVisible(!visible);
        }} style={{ marginLeft: "10px",border: "0px", borderRadius: "5px", padding: "5px" }}  >
          {visible ? "Close" : "Open"}
        </button>
     </div> </div>
      {Keys && Keys.length > 0 ? (
        ...
        <ul style={{ display: !visible ? 'none' : 'block' }}>
          {Keys.map((key, index) => (
            <li key={index}>
              <div style={{ padding: "10px" }}>
                <div style={{ marginBottom: "10px" }}>
                  ...
                  <button style={{ border: "1px solid gray", borderRadius: "5px", padding: "5px", marginRight: "5px" }} onClick={() => deleteKey(key.index)}>Delete</button>
                  <button style={{ border: "1px solid gray", borderRadius: "5px", padding: "5px" }} onClick={() => checkBalance(key.publicKey, index)}>Check Balance</button>
                </div>
                ...
                {visibleKeys.includes(index) ? (
                  <div>
                    ...
                    <button style={{ border: "1px solid gray", borderRadius: "5px", padding: "5px" }} onClick={() => handleToggle(index)}>Hide</button>
                  </div>
                ) : (
                  <div>
                    ................................................................................................................
                    <button style={{ border: "1px solid gray", borderRadius: "5px", padding: "5px" }} onClick={() => handleToggle(index)}>Show private key</button>
                  </div>
                )}
              </div>
            </li>
           ...
           {!addWallet && <button style={{ paddingRight: "10px", borderRadius: "5px", border: "0px" }} onClick={handleAdd}>Check Balance of Imported Wallet </button>}
           {addWallet && (
