...
//     const balance=item.account.data.parsed.info.tokenAmount.amount;
    ...
    return<>
        <form onSubmit={handleSubmit}>
               ...
               <button type="submit" style={{ marginLeft: "5px",borderRadius:"5px",border:"0px",height:"20px",cursor:"pointer" }}>Submit</button>
               <button onClick={()=>{setInputValue("");
               }} style={{ marginLeft: "5px",borderRadius:"5px",border:"0px",height:"20px",cursor:"pointer" }}>Clear</button>
             </form>
        <div style={{}}>
